        ...
        <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
          <div class="nav-wrapper position-relative end-0">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class=" mb-0 px-0 py-1 active d-flex align-items-center justify-content-center " data-bs-toggle="" href="explore.php?saved=1" role="tab" aria-selected="true">
...
$(document).ready(function() {
  ...
  $.ajax({
        url: "server.php",
        method: "POST",
        data: { postid: postid, userid: userid, explore: 1, saved:saved ,postfetch: 1 },
