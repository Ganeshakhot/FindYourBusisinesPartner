...
//get following 
$query = "SELECT nodes.*, user.key_1, user.first_name, user.last_name, user.profile_link, user.company FROM nodes JOIN user ON nodes.too = user.key_1 WHERE nodes.fromm = $user_id";
