...
<body class="">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('https://assets.entrepreneur.com/content/3x2/2000/20151124104355-shutterstock-297521891.jpeg');
  ...
  $('#login-form').submit(function(event) {
    ...
    // Send data to PHP server using Ajax
    $.ajax({
      type: 'POST',
      url: 'login.php',
      ...
      success: function(response) {
        ...
        } else if(response == 'adminban'){
          $('#error-message').text('You have been banned please contact support');
        }
        else {
